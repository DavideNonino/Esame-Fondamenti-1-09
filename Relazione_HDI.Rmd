...
#unione
HDIdiff <- inner_join(anno90,anno17,by=c("Code","Entity","Region")) %>% select(Entity,Code,Region,HDI1990,HDI2017) %>% mutate(differenza = HDI2017 - HDI1990)
...
In generale il Paese con la crescita più bassa è stato il Lesotho con 0.021 mentre quello con la crescita più alta è stato il Rwanda con 0.274 (considerando i valori bassi registrati nel 1993 a causa del genocidio si può dire che si stia riprendendo bene e velocemente). Gli Stati che hanno avuto una crescita maggiore sembrano appartenere in maggior quantità al continente asiatico e africano.
